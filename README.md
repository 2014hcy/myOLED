...
***write(String Text)*** function is **display string** on the **OLED** with **no new lines** and **no displaying**.<br>
***writeln(String Text)*** function is **display string** on the **OLED** with **newline** and **no displaying**.<br>
